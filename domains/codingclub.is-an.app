...
addSubDomain({
  description: 'Coding club', // describe your project in this field
  domain: 'is-an.app', // aka "root-domain". select between '1bt.uk' and 'is-an.app'
  subdomain: 'codingclub', // desired subdomain name
  owner: {
    repo: 'https://github.com/acetcs/codingClub',
    email: 'saifrahmn78@gmail.com',
  },
  record: {
    CNAME: 'acetcs.github.io', 
  },
